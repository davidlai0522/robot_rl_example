...
class Door(ManipulationEnv):
    ...
    def reward(self, action=None):
        ...
        # else, we consider only the case if we're using shaped rewards
            ...
            # function, which maps the distance to a value between 0 and 1.
            # The rotating component measures the angle rotated by the door handle, with a reward of 0.25 for a rotation of
            # 0.5 * pi radians and a reward of 0 for a rotation of greater than 0.5 * pi radians. This is done using the absolute
            # value of the angle rotated by the door handle and clipping it to be between -0.25 and 0.25.
            # -------------------------------------------------------------------------------
    ...
    # - handle_pos: 3D position of the handle
    # - hinge_qpos: joint angle of the hinge
    # - door_to_eef_pos: 3D distance from the door to the end effector
    # - handle_to_eef_pos: 3D distance from the handle to the end effector
    # - handle_qpos: joint angle of the handle (only if using a locked door version with rotatable handle)
    # 
    # For more information: https://robosuite.ai/docs/modules/environments.html
    # -------------------------------------------------------------------------------
